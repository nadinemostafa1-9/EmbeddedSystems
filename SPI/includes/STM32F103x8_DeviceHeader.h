...
#define SPI1_BASE 						     	0x40013000UL   //ABP2
#define SPI2_BASE 							    0x40003800UL  //ABP1
...
#define CLK_EN_SPI1()							(RCC->APB2ENR |= (1 << 12))
#define CLK_EN_SPI2()							(RCC->APB1ENR |= (1 << 14))
// ==================================================
...
#define NVIC_IRQ35_SPI1_ENABLE()			(NVIC_ISER2 |= 1<<(SPI1_IRQ-32))
#define NVIC_IRQ36_SPI2_ENABLE()			(NVIC_ISER2 |= 1<<(SPI2_IRQ-32))
